...
constexpr int order_max_cnt {25000}; // TODO : changeble

ll calc_satisfy(const vector<vector<ll>>& S, const vector<ll>& C, const vector<int>& order, const int& D) {
  ll answer {};
